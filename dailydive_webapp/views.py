    ...
    questions = [
        {
            ...
            'sub_question': '수면의 질',
            'answer_choices': ['아주 좋아요, 깊이 잘 잤어요.', '보통이에요, 괜찮게 잤어요.', '안 좋아요, 푹 못 잤어요.'],
            'input_before': '오늘은',
        ...
        },
        {
            ...
            'answer_choices': ['고강도*로 평소보다 숨이 훨씬 많이 찼어요.', '적당한 강도*로 평소보다 숨이 조금 더 찼어요.', '아니요, 오늘은 운동 안했어요.']
        },
        {
            'id': 3,
            'question_text': '휴식을 취했나요?',
            'answer_choices': ['네, 충분히 쉬면서 하루를 보내 개운했어요.', '적당히 쉬어서 컨디션이 괜찮아요.', '아니요, 바바써 못 쉬었더니 많이 피곤하네요.']
        },
        {
            'id': 4,
            'question_text': '식사는 잘 챙겨 먹었나요?',
            'answer_choices': ['네, 아침, 점심, 저녁을 모두 규칙적으로 먹었어요.', '그런 편이에요, 두 끼를 챙겨 먹었어요.', '아니요, 밥 대신 간식으로 간단하게 떼웠어요.']
        },
        {
            'id': 5,
            'question_text': '소셜미디어를 얼마나 썼나요?',
            'additional': '*소셜미디어: 카카오톡, 유튜브, 인스타그램처럼 사람들의 경험과 정보를 나누는 플랫폼',
            'answer_choices': ['전혀 열어보지 않았어요.', '종종 열어봤고, 1시간 이내로 썼어요.', '자주 열어보고, 1시간 이상 썼어요.']
        },
    ]
